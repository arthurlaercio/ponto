...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-md-6 icheckbox_flat-green">
            <?php echo $this->Form->input('Dias',['type'=>'select','multiple'=>'checkbox','class'=>'flat','options'=>['1'=>'Segunda', '2'=>'Terça','3'=>'Quarta', '4'=>'Quinta','5'=>'Sexta', '6'=>'Sabado','7'=>'Domingo'],'default' => array_keys($checked) ]); ?>
        </div>
    </div>
</div>
