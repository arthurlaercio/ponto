...
/**
 * BatidasAjustesFixture
 */
class BatidasAjustesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'motivo' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'criado_por' => 1,
                'created' => '2019-06-13 17:53:21',
                'modificado_por' => 1,
                'modified' => '2019-06-13 17:53:21'
            ],
        ];
        parent::init();
    }
